                ...
                success: function (data) {
                    ...
                    if(json[0].res=="vacio"){
                      ...
                      var cont_edu = [];
                        ...
                        string += '<h1>Investigaciones Destacadas<h1>';
                        var minimo=2;
                          ...
                          for (var i = 0; i < cont_edu.length; i++) {
                            var val = cont_edu[i];
                             ...
                             string += '<div class="item">';
                                  ...
                                  string += '<h6  onclick="ver_inv('+json[index].id_doc+');">'+json[index].titulo_doc+'</h6>';
                                  string += '<hr>';
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var string = '';
                              ...
                              string += '<button type="submit" onclick="inv();" class="btn boton1">Mas Investigaciones</button>';
                              string += '</div>';
